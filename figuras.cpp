...
void CFiguras::prismavar(float altura, float largo, float profundidad, GLuint text,float r, float s)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.0f, s); glVertex3fv(vertice[4]);
	glTexCoord2f(r, s); glVertex3fv(vertice[7]);
	...
	glTexCoord2f(r, s); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, s); glVertex3fv(vertice[4]);
	glEnd();

	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, s); glVertex3fv(vertice[6]);
	glTexCoord2f(r, s); glVertex3fv(vertice[5]);
	glTexCoord2f(r, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(r, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(r, s); glVertex3fv(vertice[2]);
	...
	glTexCoord2f(r, s); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, s); glVertex3fv(vertice[7]);
	glEnd();
}
...
void CFiguras::prismaLuis(float altura, float largo, float profundidad, GLuint text, float x, float y)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.0f, y); glVertex3fv(vertice[4]);
	glTexCoord2f(x, y); glVertex3fv(vertice[7]);
	glTexCoord2f(x, 0.0f); glVertex3fv(vertice[1]);
	glEnd();
	...
	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, y); glVertex3fv(vertice[6]);
	glTexCoord2f(x, y); glVertex3fv(vertice[5]);
	glTexCoord2f(x, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
...
//
void CFiguras::prismaInc(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	{ -0.5 * largo ,-0.5 * altura , -0.5 * profundidad },    //Coordenadas Vértice 3 V3
	{ 0.5 * largo ,-0.5 * altura , -0.5 * profundidad },    //Coordenadas Vértice 4 V4
	{ 0.5 * largo ,0.5 * altura , 0.5 * profundidad + 1 },    //Coordenadas Vértice 5 V5
	{ 0.5 * largo  ,0.5 * altura , -0.5 * profundidad + 1 },    //Coordenadas Vértice 6 V6
	{ -0.5 * largo ,0.5 * altura , -0.5 * profundidad + 1 },    //Coordenadas Vértice 7 V7
	{ -0.5 * largo ,0.5 * altura , 0.5 * profundidad + 1 },    //Coordenadas Vértice 8 V8
	};
...
void CFiguras::pared1(float altura, float largo, float profundidad, GLuint text,float repeticionhorizontal,float repeticionvertical)  //Funcion creacion de paredes
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f)									  ; glVertex3fv(vertice[0]);
	glTexCoord2f(0.0f, 1.0*repeticionhorizontal)				  ; glVertex3fv(vertice[4]);
	glTexCoord2f(repeticionvertical, repeticionhorizontal); glVertex3fv(vertice[7]);
	glTexCoord2f(1.0*repeticionvertical, 0.0f)					  ; glVertex3fv(vertice[1]);
	glEnd();
	...
	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 1.0*repeticionhorizontal)					; glVertex3fv(vertice[6]);
	glTexCoord2f(1.0*repeticionvertical, 1.0*repeticionhorizontal)  ; glVertex3fv(vertice[5]);
	glTexCoord2f(1.0*repeticionvertical, 0.0f)						; glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 0.0f)										; glVertex3fv(vertice[2]);
	glEnd();
...
void CFiguras::piso(float largo, float profundidad, GLuint text, int repeticion)  //Funcion creacion prisma
{

	GLfloat vertice[4][3] = {
		{ 0.5*largo ,0, 0.5*profundidad },    //Coordenadas Vértice 1 V1
	{ -0.5*largo ,0 , 0.5*profundidad },    //Coordenadas Vértice 2 V2
	{ -0.5*largo ,0, -0.5*profundidad },    //Coordenadas Vértice 3 V3
	{ 0.5*largo ,0 , -0.5*profundidad },    //Coordenadas Vértice 4 V4
	};
	glBindTexture(GL_TEXTURE_2D, text);

	glBegin(GL_POLYGON);  //plano
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0*repeticion, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(1.0*repeticion, 1.0*repeticion); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, 1.0*repeticion); glVertex3fv(vertice[3]);
	glEnd();
}

	void CFiguras::puerta(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion purtas
	{
	...
	void CFiguras::cilindro2(float radio, float altura, int resolucion, GLuint text, float tamano)
	{
		...
		float angulo = (2*3.14 / resolucion)*tamano;
